...
class Application(Frame):
    ...
    def action_automatic_open(self):
        """Triggers open file diaglog, reading a new file's metadata."""
    ...
    def action_automatic_inject(self, save_file=None):
        """Inject metadata into a new save file."""
    ...
    def __init__(self, master=None, in_file=None):
    ...
    def process_the_file(self, in_file = None):
        print("Processing the file: ", in_file)
        self.in_file = in_file
        self.action_automatic_open()
        self.var_spatial_audio.set(1)
        self.action_automatic_inject(in_file[:-4]+"_injected.mp4")
